...
BASE_URL = os.environ.get('REACT_APP_BACKEND_URL', 'https://multi-product-hub-4.preview.emergentagent.com')
    ...
    def test_checkout_creates_session_for_valid_package(self):
        ...
        response = requests.post(
            ...
            json={
                ...
                "origin_url": "https://multi-product-hub-4.preview.emergentagent.com",
