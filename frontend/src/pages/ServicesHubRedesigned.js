            ...
            <table className="w-full min-w-[800px]">
              ...
              <tbody>
                {[
                  ...
                  { name: "Survey Design", best: "Questionnaire development, sampling", timeline: "2-6 weeks", team: "2-4", deliverables: "Instruments, protocols, manuals", path: "/services/survey-design" },
                  { name: "Qualitative Research", best: "In-depth understanding, context", timeline: "1-3 months", team: "3-8", deliverables: "Transcripts, thematic reports", path: "/services/qualitative-research" },
                  { name: "GIS & Geospatial", best: "Location-based analysis, mapping", timeline: "2-8 weeks", team: "2-4", deliverables: "Maps, spatial databases", path: "/services/gis-geospatial" },
                  { name: "Digital Data Solutions", best: "Tech-enabled data collection", timeline: "2-6 weeks", team: "2-5", deliverables: "Digital tools, systems", path: "/services/digital-solutions" },
                  { name: "Program Design", best: "New program development", timeline: "4-12 weeks", team: "2-5", deliverables: "ToC, frameworks, proposals", path: "/services/program-design" },
                  { name: "Policy Research", best: "Evidence-to-policy translation", timeline: "2-4 months", team: "3-6", deliverables: "Policy briefs, recommendations", path: "/services/policy-research" },
                  { name: "Economic Analysis", best: "Cost-effectiveness, ROI studies", timeline: "4-10 weeks", team: "2-4", deliverables: "Economic reports, models", path: "/services/economic-analysis" },
                  { name: "Knowledge Management", best: "Organizational learning systems", timeline: "4-12 weeks", team: "2-4", deliverables: "KM systems, documentation", path: "/services/knowledge-management" },
