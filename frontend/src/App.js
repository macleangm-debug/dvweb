...
import { 
  ...
  Zap, Pickaxe, Plane, Landmark, Layers
} from 'lucide-react';
import {
      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="flex items-center justify-between h-20">
          ...
          <div className="hidden lg:flex items-center gap-4">
            {user ? (
              <>
                <Link to="/admin" className="text-sm text-[#64748b] hover:text-[#0a1628] flex items-center gap-1">
                  <Settings className="w-4 h-4" /> Admin
                </Link>
                <button onClick={logout} className="text-sm text-[#64748b] hover:text-[#e63946] flex items-center gap-1">
                  <LogOut className="w-4 h-4" /> Logout
                </button>
              </>
            ) : (
              <Link to="/login" className="text-sm text-[#64748b] hover:text-[#0a1628] flex items-center gap-1">
                <LogIn className="w-4 h-4" /> Admin
              </Link>
            )}
            <Link 
              to="/contact" 
              className="bg-[#e63946] text-white px-6 py-3 text-sm font-semibold uppercase tracking-wider hover:bg-[#d02835] transition-all hover:-translate-y-0.5"
