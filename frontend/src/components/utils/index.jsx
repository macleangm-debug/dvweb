...
/**
 * AnimatedCounter - Animates a number counting up when visible in viewport
 */
...
/**
 * AfricaMap - Interactive SVG map of Africa with project highlights
 */
export const AfricaMap = ({ onCountryClick }) => {
...
export default { AnimatedCounter, AfricaMap };
